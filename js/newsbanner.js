...
$(function() {
  ...
  var ratio = 0,
      ...
      wrapper = $('.newsbanner .view-content'),
      banners = $('.newsbanner .views-row', wrapper),
      links = $('#banner-nav ol li', newsbanner);

  var resizeBanners = function() {
    var bannerHeight = $('.newsbanner .view-content img')[0].offsetHeight;
  ...
  if (!!newsbanner.length) {
    ...
    var image = $('.newsbanner .view-content img').first();
